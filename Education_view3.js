...
const Education_view3 = ({ route }) => {
  ...
  const handleEditPress = () => {
    navigation.navigate('Education_edit3', { Education_Id });
  };
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.boardView}>
        ...
        <TouchableOpacity style={styles.editButton} onPress={() => navigation.navigate('Category3')}>
...
export default Education_view3;